    ...
    try:
        with open(filepath, "r", encoding="utf-8-sig") as f:
            for line in f:
                ...
                rows.append(row)
                count_total_rows += 1
        # Extracted rows without any malformed data or empty row
        extracted_rows= count_total_rows - count_malformed_rows - count_empty_rows
        ...
        # Log it
        raise RuntimeError(f"File not found or unreadable: {e}")
